import Income from "../models/expenseModel.js";
...
export const getDashboardOverview = async (req, res) => {
  ...
  try {
    ...
    console.error("DetDashboardOverview Error:", error);
    res.status(500).json({
      success: false,
      message: "An internal server error occurred on Dashboard data fetching.",
    });
  }
};
