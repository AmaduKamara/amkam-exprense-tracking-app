...
const Sidebar = ({ user, isCollapsed, setIsCollapsed }) => {
  ...
  const { name: username = "User", email = "user@amkamexptracking.com" } =
    user || {};
  ...
  const toggleSidebar = () => setIsCollapsed((collapsed) => !collapsed);
    ...
    <>
      ...
      >
        <div className={sidebarStyles.sidebarInner.base}>
          ...
          <div className='felx-1 overflow-y-auto py-4 custom-scrollbar'>
          ...
          >
            <Link
              to='https://amkam.vercel.app/#contact'
              className={cn(
